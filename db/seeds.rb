  ...
  u2 = User.create :email => 'pam@gmail.com', :password => 'chicken', :name => 'Pam', :license => '#A2480', :admin => true
  ...
  e7 = Event.create :name => 'Swoop Course', :date => '2021-08-02', :organiser => 'Felix Lavis', :coach => 'Felix Lavis', :image => '/assets/Swoop.jpg', :price => '120', :contact => 'felix@yahoo.com'
  ...
  e1.disciplines << di2
  e2.disciplines << di1 << di8
  e3.disciplines << di5 << di8
  e4.disciplines << di2
  e5.disciplines << di3
  e6.disciplines << di4 << di7
  e7.disciplines << di3
  e8.disciplines << di3
